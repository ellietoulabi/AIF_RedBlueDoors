...
python run_redbluedoors_aif_random.py --seed ${SEED} --episodes 1000 --max_steps 150 --change_every 50
EXIT_CODE=$?
...
SEED_LOG_DIR="aif_rand_log_seed_${SEED}.csv"
...
echo "Copy done"
echo "---- AIF RANDOM Seed ${SEED} complete ----"
